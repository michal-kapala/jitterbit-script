...
export class Api {
  ...
  static {
    ...
    Api.functions = [
      ...
      new Arrays.GetSourceAttrNamesFunc(),
      new Arrays.GetSourceElementNamesFunc(),
      new Arrays.GetSourceInstanceArrayFunc(),
      new Arrays.GetSourceInstanceElementArrayFunc(),
      new Dicts.GetSourceInstanceMapFunc(),
      new Dicts.GetSourceInstanceElementMapFunc(),
